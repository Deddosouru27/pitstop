...
import { FolderOpen, Lightbulb, BookOpen, Network, MoreHorizontal, X, BarChart2, Brain, Target, Inbox, Settings, ScrollText, ListTodo, TrendingUp, Activity, Users, Compass, Bell, CheckSquare, ShieldCheck } from 'lucide-react'
