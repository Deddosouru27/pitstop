...
import { FolderOpen, Lightbulb, BarChart2, Brain, BookOpen, Target, Inbox, Settings, Network, Bot, ScrollText, ListTodo, TrendingUp } from 'lucide-react'
...
const tabs = [
  ...
  { to: '/stats',      icon: TrendingUp,  label: 'Stats',     badge: false },
