...
const FIELDS = 'id,content,knowledge_type,project_id,immediate_relevance,strategic_relevance,novelty,effort,has_ready_code,routed_to,tags,source_url,source_type,business_value,ingested_content_id,superseded_by,entities,created_at'
